        ...
        bottomNavigationView.setOnItemSelectedListener(new BottomNavigationView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.inicio) {
                    ...
                    Intent intent2 = new Intent(NewsActivity.this, MapaActivity.class);
                    startActivity(intent2);
                } else if (item.getItemId() == R.id.reciclaje) {
                    // Navegar a la actividad de Recolección
                    Intent intent3 = new Intent(NewsActivity.this, RecoleccionActivity.class);
                    startActivity(intent3);
                } else if (item.getItemId() == R.id.ajustes) {
                    // Navegar a la actividad de Settings
                    Intent intent4 = new Intent(NewsActivity.this, SettingsActivity.class);
